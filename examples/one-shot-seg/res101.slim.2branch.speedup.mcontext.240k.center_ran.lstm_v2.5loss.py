...
#python res101.slim.2branch.speedup.mcontext.240k.center_ran.lstm_v2.5loss.py --test_load train_log/res101.slim.2branch.speedup.mcontext.240k.center_ran.lstm_v2.5loss:fold0_5shot_test/model-8000 --k_shot 1 --test --test_data fold0_1shot_test --gpu 1

#python res101.slim.2branch.speedup.mcontext.240k.center_ran.lstm_v2.5loss.py --test_load train_log/res101.slim.2branch.speedup.mcontext.240k.center_ran.lstm_v2.5loss:fold0_5shot_test/model-8000 --k_shot 10 --test --test_data fold0_10shot_test --gpu 1
