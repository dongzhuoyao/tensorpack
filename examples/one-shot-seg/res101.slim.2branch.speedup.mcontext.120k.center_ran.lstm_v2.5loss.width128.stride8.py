...
from deeplabv2_dilation6_new_mtscale_stride8 import deeplabv2
    ...
    def build_graph(self, first_image_masked, second_image, second_label):
        ...
        with tf.variable_scope('') as scope:
            for kth_shot in range(args.k_shot):
                ...
                fusion_branch = smooth(fusion_branch,1,"context_fusion0",stride=1)
