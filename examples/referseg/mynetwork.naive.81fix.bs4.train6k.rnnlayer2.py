...
class Model(ModelDesc):
    ...
    def _build_graph(self, inputs):
        ...
        model = RMI_model(image, caption, num_rnn_layers=2, class_num=CLASS_NUM, batch_size=current_batch_size, num_steps= STEP_NUM, mode=mode, vocab_size=VOCAB_SIZE, weights="deeplab")
        predict = model.up
