...
class RMI_model(object):
    ...
    def __init__(self, img, caption, class_num ,batch_size,
        ...
        self.words = caption#tf.placeholder(tf.int32, [self.batch_size, self.num_steps])
    ...
    def build_graph(self):
        ...
        conv2 = self._conv("conv2", mlp, 1, self.mlp_dim, self.class_num, [1, 1, 1, 1])
        self.pred = conv2
