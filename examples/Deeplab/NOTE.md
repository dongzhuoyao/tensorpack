...
deeplabv2.voc.imagesize473|imagesize:473;first_batch_lr = 2.5e-4;lr_schedule = [(2, 1e-4), (4, 1e-5), (6, 8e-6)];epoch_scale = 8;max_epoch = 10; **compared with deeplabv2.voc.size512, differ in (1). imagesize 512*10, here is 473*15, lr_multi =10, here is lr_multi=5** |71.5
