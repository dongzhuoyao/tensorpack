...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir', default="/data2/dataset/pascalvoc2012/VOC2012trainval/VOCdevkit/VOC2012",help='dataset dir')

    #parser.add_argument('--data_dir', default="/zdata/hutao/dataset/VOCdevkit/VOC2012",help='dataset dir')
